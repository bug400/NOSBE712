/*
 * This autojob configuration configures and builds  a minimum configured 
 * system (user library method) which can be used to build the *full* system
 *
 * This takes about 2h on a Raspberry Pi4 (Debian 64bit)
 * After successful completion you can run the jobs to build the deadstart tape
 * with the command ./autojob.js build_dstape_mini
 *
...
config: [
 ...
 [17,"PL1B","buildjobs/19_pl1b.txt",[["../NOSBE650/PL1B1P5.tap","","r"],["scratch/PL1B.tap","PL1B00","w"],["scratch/BINB.tap","BINB00","w"]]],
 [18,"PL70","buildjobs/20_pl70.txt",[["../NOSBE650/CCL1P1.tap","","r"],["scratch/PL70.tap","PL7000","w"]]],
 [19,"PL8A","buildjobs/20b_pl8a.txt",[]],
 [20,"ULIB","buildjobs/50_ulib.txt",[]],
 [2,"DST1","buildjobs/51_dst1_buildsys.txt",[["scratch/DSTAPE_BUILDSYS.tap","NEWSYS","w"]]]
]
});
